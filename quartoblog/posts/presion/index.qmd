...
date: "2022-07-07"
categories: [codigo, analisis, video]
image: "image.jpg"
---

### Presentación

El presente documento es un material de trabajo preliminar, creado a partir de los [diálogos de innovación](https://www.nucleodeinnovacion.com/post/di%C3%A1logos-de-innovaci%C3%B3n) llevados adelante por el [**NIS**](https://www.nucleodeinnovacion.com/) durante 2022 e iterado en un **taller abierto** en articulación con los Colegios Profesionales de Sociología de Provincia de Buenos Aires y CABA, y tiene como objetivo dar cuenta de una experiencia de **integración** de lenguajes de programación aplicados al procesamiento de la Encuesta Permanente de Hogares (EPH de [INDEC](https://www.indec.gob.ar/)), posible gracias [**Quarto**](https://quarto.org/), un sistema de publicación científica y técnica basado en Pandoc[^1] que funciona de manera amigable con Rstudio[^2].
...
Al concluir el documento se presenta el video formativo que recupera la experiencia en vivo.
